            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('User\ProfileController@create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select type="text" class="form-control" name="age_id">
                                {{-- プルダウンメニュー --}}
                                <option value=" " @if(old('age_id') == " ") selected="selected" @endif>選択してください</option>
                                @foreach($ages as $age)
                                    <option value="{{ $age->id }}" @if(old('age_id') == ($age->id)) selected="selected" @endif>{{ $age->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="best_movie" value="{{ old('best_movie') }}">
                        </div>
                    </div>
